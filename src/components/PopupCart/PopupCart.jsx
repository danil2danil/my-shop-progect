    ...
    return (
        <div className={isPopupActive ? "popup active" : "popup"}>
            ...
            <div className="popup__names">
                ...
                <p className="popup__names-item popup__names-item--size">Размер</p>
            ...
            {cart.map(item => {
                return (
                    <div key={item.product.id} className="popup__item">
                        ...
                        <h4 className="popup__item-title">
                            {item.product.title} <span className='popup__size-span'>{item.sizeValue}cм</span>
                        </h4>
